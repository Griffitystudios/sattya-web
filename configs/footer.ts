...
export const footerConfig: FooterProps = {
    ...
    spaceLogos: [
        { src: "/images/makerspace/logo.png", alt: "Maker Art Space", link: "/makerspace" },
        { src: "/images/artcafe/logo.png", alt: "Art Cafe", link: "/artcafe" },
        { src: "/images/cologo.png", alt: "Cowork", link: "/cowork" },
        { src: "/images/stay/logo.png", alt: "Stay", link: "/stay" },
        { src: "/images/podlab/logo.png", alt: "The Pod Lab", link: "/podlab" },
        { src: "/images/aloft/logo.png", alt: "Loft", link: "/loft" },
        { src: "/images/roof/logo.png", alt: "Roof", link: "/roof" },
    ],
