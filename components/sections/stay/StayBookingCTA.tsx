    ...
    return (
        <section ref={sectionRef} className="z-100 py-16 px-6 lg:px-16">
            ...
            <div className="max-w-2xl mx-auto flex flex-col items-center gap-6 text-center">
                ...
                {subheading && (
                    <p ref={subheadingRef} className="h3 text-black max-w-2xl">
                        {subheading}
                    </p>
                )}
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 mt-2">
                    ...
                    >
                        ...
                        <div className="cta-inner relative bg-white border border-black px-6 py-2.5 p-bold text-black flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 256 256" className="h-5 w-5">
                    ...
                    {secondaryCTALabel && secondaryCTAHref && (
                        ...
                        >
                            <div
                                className="absolute translate-y-1 translate-x-1 w-full h-full border border-black opacity-0 group-hover:opacity-100 transition-opacity"
                                style={{ backgroundColor: "#000" }}
                            />
                            <div
                                className="relative border border-black px-6 py-2.5 p-bold text-black flex items-center gap-2 transition-transform group-hover:-translate-x-0.5 group-hover:-translate-y-0.5"
                                style={{ backgroundColor: secondaryCTAColor ?? "#C4AD95" }}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" viewBox="0 0 256 256" className="h-5 w-5">
                                    <path d="M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM72,48v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V80H48V48ZM208,208H48V96H208V208Zm-96-88v64a8,8,0,0,1-16,0V132.94l-4.42,2.22a8,8,0,0,1-7.16-14.32l16-8A8,8,0,0,1,112,120Zm59.16,30.45L152,176h16a8,8,0,0,1,0,16H136a8,8,0,0,1-6.4-12.8l28.78-38.37A8,8,0,1,0,145.07,132a8,8,0,1,1-13.85-8A24,24,0,0,1,176,136,23.76,23.76,0,0,1,171.16,150.45Z" />
                                </svg>
