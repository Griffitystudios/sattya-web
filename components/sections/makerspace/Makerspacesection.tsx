...
export default function MakerspaceSection({
  imageSrc = "/images/makerspace/para-image.png",
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="flex flex-col gap-2 items-start">
          <div className="w-fit" ref={headingRef}>
            <h2 className="h1 text-makerspace uppercase leading-none">
              Build, Repair{" "}
              <span className="relative inline-block">
                Create
                <span
                  ref={togetherRef}
                  className="h1-alt text-black absolute lowercase -bottom-3 lg:-bottom-5 -right-2"
                >
                  together
                </span>
              </span>
          ...
          <div className="flex flex-col gap-4 lg:max-w-lg">
            <p ref={para1Ref} className="p text-black/80">
              The Makerspace @ Sattya is a hands-on workspace for building and
              fixing things.
            </p>
            <p ref={para2Ref} className="p text-black/80">
              Tools and knowledge are shared here, making the Makerspace a
              community workspace where people experiment and build.
            </p>
          </div>
        ...
        <div className="relative mt-20 lg:mt-0 flex items-center justify-center">
          ...
          >
            <div
              ref={orangeShadowRef}
              className="absolute bg-makerspace"
              style={{ inset: 0 }}
            />
